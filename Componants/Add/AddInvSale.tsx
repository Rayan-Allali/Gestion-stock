...
const AddInvSale:React.FC<props> = (props) => {
  ...
  const [data, setdata] = useState( Type )
   ...
   async function SaveClicked() {
    ...
    return ( 
    <motion.div  className="w-[600px] ml-[100px] absolute top-[50%] right-[50%] translate-x-[50%] translate-y-[-50%] shadow-2xl font-semibold
    ...
    <FiX></FiX></div>
        ...
        <form >
        <div className="flex flex-col items-center w-full px-4 my-6 gap-8 ">
        <div className="relative">
           <Image src={NewAdd} className="absolute h-[20px] w-[20px] translate-y-[-50%] top-[50%] left-5 " alt=""></Image>
        ...
        <div className='flex gap-10'>
         ...
         <div className="">
            <input type="text" onChange={(e)=>handleChange(e,3)} placeholder="Qte"   className="  pl-[5%] rounded-[5px] w-[190px] h-[40px] border border-solid border-[#a6a7a8] " />
         </div>
        </div>
        <div  className="w-[120px] h-[38px] bg-[#F1F4FB] rounded-[5px] cursor-pointer text-[#017AFF] text-[13px] flex justify-center 
            gap-2 items-center self-start  "  > 
